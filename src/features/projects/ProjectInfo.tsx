  ...
  return (
    <div className='flex flex-col gap-4 rounded-lg bg-white p-6'>
      ...
      <div className='flex flex-col'>
        <span className='font-gilroy-medium text-base font-medium text-midnight-grey'>Project Velocity</span>
        <span className='font-gilroy-regular text-base font-normal text-slate-mist'>{project.projectVelocity}</span>
      </div>
    </div>
  );
};
