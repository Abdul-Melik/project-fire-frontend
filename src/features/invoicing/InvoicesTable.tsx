					...
					{invoices.map(invoice => {
						...
						return (
							<TableRow key={invoiceId}>
								<td className='w-[263px] p-4'>{invoice.client}</td>
								<td className='w-[180px] p-4'>{invoice.industry}</td>
								<td className='w-[142px] p-4'>{invoice.totalHoursBilled}</td>
								<td className='w-[180px] p-4'>{invoice.amountBilledBAM}</td>
								<td className='w-[101px] p-4'>
