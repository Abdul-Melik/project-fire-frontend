...
const ViewInvoice = ({ invoice, closeViewInvoiceSideDrawer, openEditInvoiceSideDrawer }: Props) => {
	...
	return <SideDrawer onClick={closeViewInvoiceSideDrawer}>{children}</SideDrawer>;
};
