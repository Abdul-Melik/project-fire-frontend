...
import Backdrop from 'src/components/shared/utils/Backdrop';
...
const Modal = ({ className, show, header, handleConfirmation, handleCancellation, isError, children }: Props) => {
	const content = (
		<>
			...
			{show && (
				...
				>
					<header className='w-full bg-deep-teal p-4 text-white'>
						<h2 className='font-gilroy-semi-bold text-xl font-semibold'>{header}</h2>
					</header>
