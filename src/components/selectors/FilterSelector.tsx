...
const FilterSelector = ({ handleYearSelect, label, options, defaultValue }: Props) => {
	...
	return (
		<div className='flex items-center'>
			<span className='mr-4 font-gilroy-bold text-[22px] font-bold leading-[30px] text-deep-forest'>Filter:</span>
			<div
				ref={ref}
			...
			>
				<span className='font-gilroy-bold text-base font-bold text-hunter-green'>{selectedValue}</span>

				<img className={`transition ${isSelectorOpen ? 'rotate-180' : ''}`} src={arrow} alt='Down icon' />
				{isSelectorOpen && (
					<div
