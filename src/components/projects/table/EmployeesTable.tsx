            ...
            <tbody>
              {employees.map((employee) => {
                ...
                return (
                  <TableRow
                    key={employeeId}
                    className={`duration-500 hover:transform hover:cursor-pointer hover:bg-ashen-grey hover:text-base hover:transition-transform ${
                      selectedRows.includes(employeeId) ? "border-y border-t border-gray-400 bg-pale-silver" : ""
                    }`}
                    onClick={(event) => {
