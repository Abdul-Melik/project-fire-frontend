...
const Projects = () => {
  ...
  return (
    <div className="flex h-screen not-italic">
      <div className="w-1/5 border-r border-gray-300 bg-green-100">
        <div className="p-8">
      ...
      <div className="page-content ml-4 mr-8 flex-1 p-4">
        <div className="content-categories flex items-center">
          <div className="flex-1 p-8 py-4 text-2xl text-3xl font-bold">
            Projects
          </div>
            ...
            <div className="flex items-center justify-between py-4">
              <div className="flex">
                <div className="relative">
                  ...
                  <label
                    htmlFor="opt-1"
                    className="cursor-pointer rounded-l-md border border-gray-400 px-4 py-2 text-sm font-semibold text-[#43A57C] transition-colors duration-200 ease-in-out hover:bg-green-100 focus:bg-[#F5FFFA]"
                  >
                    All projects
                  </label>
                </div>
                <div className="relative">
                  ...
                  <label
                    htmlFor="opt-2"
                    className="cursor-pointer border border-gray-400 px-4 py-2 text-sm font-semibold text-[#43A57C] transition-colors duration-200 ease-in-out hover:bg-green-100 focus:bg-green-100"
                  >
                    Active
                  </label>
                </div>
                ...
                <div className="relative">
                  ...
                  <label
                    htmlFor="opt-4"
                    className="cursor-pointer rounded-r-md border border-gray-400 px-4 py-2 text-sm font-semibold text-[#43A57C] transition-colors duration-200 ease-in-out hover:bg-green-100 focus:bg-green-100"
                  >
                    Completed
                  </label>
                </div>
