  ...
  return (
    <div className="flex h-screen not-italic ">
      ...
      <div className="page-content ml-4 mr-4 flex-1 p-4">
        <div className="flex-1 p-8 py-4 text-2xl text-3xl font-bold">Home</div>
            ...
            <div className="flex items-center justify-between py-4">
              <div className="flex">
                ...
                <div className="relative">
                  ...
                  <label
                    htmlFor="opt-2"
                    className="cursor-pointer border border-gray-400 px-4 py-2 text-sm font-semibold text-[#43A57C] transition-colors duration-200 ease-in-out hover:bg-green-100 focus:bg-[#F5FFFA]"
                  >
                ...
                <div className="relative">
                  ...
                  <label
                    htmlFor="opt-3"
                    className="cursor-pointer rounded-r border border-gray-400 px-4 py-2 text-sm font-semibold text-[#43A57C] transition-colors duration-200 ease-in-out hover:bg-green-100 focus:bg-[#F5FFFA]"
                  >
                    2023 Plan
                  </label>
                </div>
